...
void ImGui::TableSetupColumn(const char* label, ImGuiTableColumnFlags flags, float init_width_or_weight, ImGuiID user_id)
{
    ...
    if (table->IsInitializing)
    {
        ...
        // OnCreate default visibility/sort state
...
//-------------------------------------------------------------------------
// [OnCreate] 1: TableSettingsHandler_ReadXXXX()   Load and parse .ini file into TableSettings.
...
void ImGui::TableSaveSettings(ImGuiTable* table)
{
    ...
    // SerializeScene ImGuiTable/ImGuiTableColumn into ImGuiTableSettings/ImGuiTableColumnSettings
    IM_ASSERT(settings->ID == table->ID);
...
void ImGui::TableLoadSettings(ImGuiTable* table)
{
    ...
    // SerializeScene ImGuiTableSettings/ImGuiTableColumnSettings into ImGuiTable/ImGuiTableColumn
    ImGuiTableColumnSettings* column_settings = settings->GetColumnSettings();
